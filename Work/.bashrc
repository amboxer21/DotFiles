...
export PATH="$PATH:$SDK:/usr/local/share/gems/bin:/opt/gradle/gradle-3.3/bin:/usr/local/bin:/sbin:/usr/sbin"
...
PATH="/usr/local/ruby-2.3.3/bin:/home/anthony/perl5/bin${PATH:+:${PATH}}"; export PATH;
...
alias rpi3="ssh -pport pi@homes_public_ip_address"
alias appdev1_y="ssh aguevara@appdev1 -Y"
alias fsa="ssh aguevara@fsa"
alias hosted="ssh aguevara@hosted"
alias mgspare="ssh aguevara@mgspare"
alias home_server="ssh -pport codecaine21@homes_public_ip_address"
